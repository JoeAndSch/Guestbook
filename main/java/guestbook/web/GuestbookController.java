...
class GuestbookController {
	...
	String addEntry(@Valid GuestbookForm form, Errors errors, Model model) {
		...
		guestbook.save(new GuestbookEntry(form.getfirstName(), form.getlastName(), form.getText()));
		return "redirect:/guestbook";
	}
	...
	String addEntry(@Valid GuestbookForm form, Model model) {
		...
		model.addAttribute("entry", guestbook.save(new GuestbookEntry(form.getfirstName(), form.getlastName(), form.getText())));
