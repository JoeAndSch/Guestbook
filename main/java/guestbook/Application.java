...
public class Application {
	...
	void initialize() {
		...
		guestbook.save(new GuestbookEntry("H4xx0r","1337", "first!!!"));
		guestbook.save(new GuestbookEntry("Arni","Schwarzenegger", "Hasta la vista, baby"));
		guestbook.save(new GuestbookEntry("Duke", "Nukem",
				"It's time to kick ass and chew bubble gum. And I'm all out of gum."));
		guestbook.save(new GuestbookEntry("Gump","Forrest",
